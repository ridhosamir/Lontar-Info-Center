                                    ...
                                    <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                        <div class="poster-container">
                                            <img src="{{ asset('images/posters/' . $poster->gambar) }}"
                                                alt="PLN Indonesia Power Plant {{ $index + 1 }}" class="company-image">
                                        </div>
                                    </div>
                                @empty
                                    ...
                                    <div class="carousel-item active">
                                        <div class="poster-container">
                                            <img src="{{ asset('storage/images/bg-login.jpeg') }}"
                                                alt="PLN Indonesia Power Plant 1" class="company-image">
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <div class="poster-container">
                                            <img src="{{ asset('storage/images/bg-banner.jpeg') }}"
                                                alt="PLN Indonesia Power Plant 2" class="company-image">
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <div class="poster-container">
                                            <img src="{{ asset('storage/images/poster.jpeg') }}"
                                                alt="PLN Indonesia Power Plant 3" class="company-image">
                                        </div>
                                    </div>
                                @endforelse
                            </div>
...
Tidak ada portal yang ditemukan untuk "{{ request('search') }}".
                            ...
                            @if (isset($portalItems) && count($portalItems) > 0)
                                @foreach ($portalItems as $item)
                                    <div class="col-md-4 col-sm-6 mb-4">
                                        ...
                                        <a href="{{ route('portal.click', $item->id_portal_utama) }}"
                                            class="text-decoration-none" target="_blank">
                                            <div class="card portal-card">
                                                <div
                                                    class="card-body d-flex flex-column justify-content-center align-items-center py-2">
                                                    <div class="portal-icon-wrapper">
                                                        <i class="fas fa-portal"></i>
                                                    </div>
                                                    <h4 class="text-center portal-title mb-1">{{ $item->nama_portal_user }}
                                                    </h4>
                                                    <div class="text-center portal-subtitle">{{ $item->keterangan_user }}
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <nav>
                                        <ul class="pagination justify-content-center">
                                            ...
                                            @else
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="{{ $portalItems->previousPageUrl() }}">&laquo;</a>
                                                </li>
                                            @endif
                                            ...
                                            @for ($i = 1; $i <= $portalItems->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $portalItems->currentPage() == $i ? 'active' : '' }}">
                                                    <a class="page-link"
                                                        href="{{ $portalItems->url($i) }}">{{ $i }}</a>
                                                </li>
                                            @endfor
                                            ...
                                            @if ($portalItems->hasMorePages())
                                                <li class="page-item">
                                                    <a class="page-link"
                                                        href="{{ $portalItems->nextPageUrl() }}">&raquo;</a>
                                                </li>
                                            @else
                                                <li class="page-item disabled">
    ...
    <div class="copyright-footer">
        <div class="container-fluid">
            <a href="#" class="copyright-link" data-bs-toggle="modal" data-bs-target="#loginModal">Copyright ©️
                2025 PLN Indonesia Power Services. All Rights Reserved</a>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="login-container">
                        ...
                        <div class="login-image"
                            style="background-image: url('{{ asset('storage/images/bg-login.jpeg') }}')">
                        ...
                        <div class="login-form">
                            ...
                            <!-- Login form -->
                            <form id="loginForm" method="POST" action="{{ route('login') }}" style="width: 100%;"
                                onsubmit="return validateLoginForm()">
                                @csrf
                                <div class="form-group mb-3">
                                    <input type="text" class="form-control mb-1" id="username" name="username"
                                        placeholder="Username" value="{{ old('username') }}">
                                    <span id="usernameError" class="text-danger error-message d-none">Username tidak
                                        boleh kosong</span>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <span id="passwordError" class="text-danger error-message d-none">Password tidak
                                        boleh kosong</span>
                                </div>
                ...
                $(document).ready(function() {
                    ...
                    $('#loginForm').on('submit', function(e) {
                        if (!validateLoginForm()) {
                            ...
                            var loginModal = bootstrap.Modal.getInstance(document.getElementById(
                                'loginModal'));
                            if (!loginModal) {
                                loginModal = new bootstrap.Modal(document.getElementById(
                                    'loginModal'), {
                                    backdrop: 'static',
                                    keyboard: false
                                });
